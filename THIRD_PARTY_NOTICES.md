...
| [Spotify Ads Agentic Tools](https://github.com/spotify/ads-agentic-tools) | Apache-2.0 | `packages/shared/src/skills/bundled/spotify-ads-manager/SKILL.md`, Spotify paths in `tools/ads-operator/` | Campaign hierarchy, draft-review-publish, reporting, and monitoring concepts were adapted for Artist OS browser operation. No Spotify API client or credentials are bundled. |
