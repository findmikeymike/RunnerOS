...
exports.assertBundledBun = function assertBundledBun(projectDir, platform) {
  ...
  try {
    ...
    throw new Error('Artist OS packaging requires a nonempty executable bundled Bun runtime in vendor/bun. Prepare the target runtime with the checksum-verified downloadBun helper in scripts/build/common.ts before packaging.')
  }
}
