...
1. **Workspace skill checked first** - If `~/.trade-god/workspaces/{id}/skills/commit/SKILL.md` exists, it's used
...
```
~/.trade-god/workspaces/{workspaceId}/skills/{slug}/
...
```bash
mkdir -p ~/.trade-god/workspaces/{ws}/skills/my-skill
```
...
1. Create `~/.trade-god/workspaces/{ws}/skills/commit/SKILL.md`
