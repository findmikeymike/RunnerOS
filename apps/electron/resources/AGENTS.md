...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.trade-god/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.trade-god/docs/` | Always overwrite on launch |
| `themes/` | `~/.trade-god/themes/` | Always overwrite on launch |
| `permissions/` | `~/.trade-god/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.trade-god/tool-icons/` | Always overwrite on launch |
| `config-defaults.json` | `~/.trade-god/config-defaults.json` | Always overwrite on launch |
