...
async function getExpectedCoreChannels(): Promise<Set<string>> {
  ...
  const [
    ...
    import('@craft-agent/server-core/handlers/rpc/agenda'),
    import('@craft-agent/server-core/handlers/rpc/community'),
    import('@craft-agent/server-core/handlers/rpc/composio'),
    import('@craft-agent/server-core/handlers/rpc/website'),
    ...
    import('@craft-agent/server-core/handlers/rpc/hq-state'),
    import('@craft-agent/server-core/handlers/rpc/shared-intel'),
    import('@craft-agent/server-core/handlers/rpc/signals'),
    import('@craft-agent/server-core/handlers/rpc/google-workspace'),
    import('@craft-agent/server-core/handlers/rpc/community-email'),
    import('@craft-agent/server-core/handlers/rpc/artist-vault'),
    ...
    import('@craft-agent/server-core/handlers/rpc/lab-inspiration'),
  ...
  return new Set([
    ...
    ...agenda.HANDLED_CHANNELS,
    ...community.HANDLED_CHANNELS,
    ...composio.HANDLED_CHANNELS,
    ...website.HANDLED_CHANNELS,
    ...
    ...hqState.HANDLED_CHANNELS,
    ...sharedIntel.HANDLED_CHANNELS,
    ...signals.HANDLED_CHANNELS,
    ...googleWorkspace.HANDLED_CHANNELS,
    ...communityEmail.HANDLED_CHANNELS,
    ...artistVault.HANDLED_CHANNELS,
    ...missionAssets.HANDLED_CHANNELS,
    ...releaseKit.HANDLED_CHANNELS,
    ...deepResearch.HANDLED_CHANNELS,
    ...labInspiration.HANDLED_CHANNELS,
