        ...
        <div className="settings-content-scroll px-6 py-6">
          {loading ? (
            ...
            <div className="mx-auto max-w-[720px] space-y-6">
              ...
              <SettingsSection
                title="Team mode"
                description="Shared Folder Team Mode is for trusted collaborators. Folder access is the security boundary: collaborators can read shared data and edit files outside RunnerOS."
                action={
              ...
              {status?.team.enabled && (
                <SettingsSection
                  ...
                  description="Checks Team metadata, runner heartbeats, and record conflicts. Your sync provider's full file state remains outside RunnerOS."
                >
                  <SettingsCard>
                    <SettingsCardContent>
                      <div className="flex items-center justify-between gap-4">
