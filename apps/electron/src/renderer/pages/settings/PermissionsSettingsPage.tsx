 ...
 * Shows both default patterns (from ~/.trade-god/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.trade-god/permissions/default.json.
...
/**
 * Build default permissions data from ~/.trade-god/permissions/default.json.
