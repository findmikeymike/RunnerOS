      ...
      >
        ...
        {links.map((item) => {
          ...
          if (isSeparatorItem(item)) {
            ...
            return (
              <div key={item.id} className={cn("py-1 px-2", isBrainSeparator && "pl-[22px] pr-0")} aria-hidden="true">
                <div className={cn("h-px bg-foreground/5", isBrainSeparator && "w-16 bg-white/18")} />
              </div>
            )
          }
