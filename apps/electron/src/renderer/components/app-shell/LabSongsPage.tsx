...
const SAMPLE_SONGS: SongRecord[] = [
  {
    ...
    preview: 'I keep leaving town but every red light knows my name.',
    project: 'Loose Singles',
    focused: true,
    status: 'working',
    editedAt: '2026-07-05T17:40:00',
    createdAt: '2026-07-05T12:30:00',
  },
  {
    id: 'pretty-trouble',
    title: 'Pretty trouble',
    preview: 'Looking expensive, feeling unstable, making it sound controlled.',
    project: 'EP One',
    focused: true,
    status: 'working',
    editedAt: '2026-07-04T21:10:00',
    createdAt: '2026-07-03T11:00:00',
  },
  {
    id: 'backseat-prophecy',
    title: 'Backseat prophecy',
    preview: 'Everybody called the ending while I was still becoming it.',
    project: 'Loose Singles',
    focused: false,
    status: 'working',
    editedAt: '2026-07-02T16:20:00',
    createdAt: '2026-06-29T15:00:00',
  },
  {
    id: 'soft-exit',
    title: 'Soft exit',
    preview: 'A quiet leaving song. No revenge, just disappearing clean.',
    project: 'Album Sketches',
    focused: false,
    status: 'done',
    editedAt: '2026-06-30T18:20:00',
...
export function LabSongsPage({ workspaceName }: LabSongsPageProps) {
  const [filterPreset, setFilterPreset] = React.useState<FilterPreset>('all')
  const [query, setQuery] = React.useState('')

  const projects = React.useMemo(
    () => Array.from(new Set(SAMPLE_SONGS.map((song) => song.project))),
    [],
  )
    ...
    <div className="h-full overflow-y-auto bg-[#050505] text-foreground">
      <div className="flex w-full flex-col gap-3 px-5 py-4 xl:px-8 xl:py-5">
        ...
        <div className="text-xs text-white/28">
          Showing {visibleSongs.length} of {SAMPLE_SONGS.length} songs in {workspaceName || 'Creative Lab'}.
        </div>
      </div>
    </div>
  )
