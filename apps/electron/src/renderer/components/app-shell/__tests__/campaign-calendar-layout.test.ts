...
describe('Calendar page layout', () => {
  ...
  test('Plan can use a continuous soot calendar without changing the shared dark default', () => {
    ...
    expect(monthGrid).toContain("#090A0B] shadow-[inset_0_0_0_1px_#f97316]")
    expect(monthGrid).not.toContain("bg-white shadow-[inset_0_0_0_1px_#f97316]")
    ...
    expect(monthGrid).toContain("bg-[#17191B] shadow-[inset_0_0_0_1px_#f97316]")
