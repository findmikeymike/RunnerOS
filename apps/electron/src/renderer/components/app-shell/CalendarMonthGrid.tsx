...
export function CalendarMonthGrid({
  ...
  return (
    <div className="rounded-[16px] border border-white/[0.10] bg-[#232629] p-2.5">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isSelected
                  ? 'border-orange-400/60 bg-[#342014] hover:bg-[#402619]'
                  : isCurrentMonth
                    ? 'border-white/[0.09] bg-[#17191b] hover:bg-[#1e2124]'
                    : 'border-white/[0.035] bg-[#0e1012] hover:bg-[#131619]',
              )}
            >
              <span className={cn(
                'text-xs font-medium',
