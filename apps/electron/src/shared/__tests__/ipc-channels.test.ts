...
// Explicit wire-format baseline. Review intentional protocol additions before updating.
const EXPECTED_CHANNELS: string[] = [
  ...
  "LLM_Connection:getFallbackChain",
  "LLM_Connection:list",
  "LLM_Connection:listWithStatus",
  "LLM_Connection:refreshModels",
  "LLM_Connection:save",
  "LLM_Connection:setConnectionFallbackChain",
  "LLM_Connection:setDefault",
  "LLM_Connection:setFallbackChain",
  "LLM_Connection:setWorkspaceDefault",
  "LLM_Connection:test",
  "agenda:taskThread:addComment",
  "agenda:taskThread:delete",
  "agenda:taskThread:get",
  ...
  "artist-profile-enrichment:cancel",
  "artist-profile-enrichment:changed",
  "artist-profile-enrichment:correct",
  "artist-profile-enrichment:get",
  "artist-profile-enrichment:remove",
  "artist-profile-enrichment:start",
  "artist-profile-enrichment:undo",
  ...
  "artistVault:scan",
  "artistVault:transcribeTrack",
  "artistVault:updateAsset",
  "auth:logout",
  ...
  "automations:setSnoozedUntil",
  "automations:test",
  "badge:draw",
  "badge:draw-windows",
  "badge:refresh",
  "badge:setIcon",
  "brandingState:addAttachment",
  "brandingState:apply",
  "brandingState:changed",
  "brandingState:dismiss",
  "brandingState:get",
  "brandingState:propose",
  "brandingState:removeAttachment",
  ...
  "browser-pane:hide-sidecar",
  "browser-pane:interacted",
  "browser-pane:list",
  "browser-pane:navigate",
  "browser-pane:pop-out",
  "browser-pane:reload",
  ...
  "browser-pane:stop",
  "browser-pane:update-dock-bounds",
  ...
  "community:setRoutine",
  "community:suppress",
  "community:updateEmailJob",
  "composio:connect",
  "composio:disconnect",
  "composio:refresh",
  "composio:saveKey",
  ...
  "gitbash:check",
  "gitbash:setPath",
  "googleWorkspace:getCalendarStatus",
  "googleWorkspace:syncCalendar",
  "hqState:getRecommendationDetail",
  "hqState:launchRecommendation",
  "hqState:listRecommendations",
  "hqState:refresh",
  "hqState:setRecommendationUsefulness",
  "hqState:transitionRecommendation",
  ...
  "input:setSpellCheck",
  "lab:getState",
  "lab:inspirationCancel",
  "lab:inspirationList",
  "lab:inspirationSave",
  "lab:inspirationStart",
  "lab:saveState",
  "lab:updated",
  "labels:changed",
  "labels:create",
  ...
  "missionAssets:saveLyrics",
  "missionAssets:scan",
  "missionAssets:transcribeLyrics",
  ...
  "outputs:archiveSocialVariant",
  "outputs:createSocialVariantSet",
  "outputs:delete",
  "outputs:get",
  ...
  "releaseKit:changed",
  "releaseKit:chooseUpload",
  "releaseKit:get",
  "releaseKit:getItem",
  "releaseKit:listUses",
  "releaseKit:migrateLegacy",
  "releaseKit:openFolder",
  "releaseKit:promote",
  "releaseKit:remove",
  "releaseKit:setPrimary",
  "releaseKit:updateUsage",
  "releaseKit:verify",
  "releaseNotes:get",
  ...
  "resources:export",
  "resources:import",
  "scheduledWork:approveCampaignSocial",
  "scheduledWork:authorizeReleaseKitSocial",
  ...
  "scheduledWork:mutateXEditorialCandidate",
  "scheduledWork:reauthorizeReleaseKitSocial",
  "scheduledWork:resolveCampaignOutput",
  ...
  "sessions:watchFiles",
  "settings:adBrowserAccounts:delete",
  "settings:adBrowserAccounts:list",
  "settings:adBrowserAccounts:login",
  "settings:adBrowserAccounts:save",
  "settings:adBrowserAccounts:status",
  ...
  "settings:socialAccounts:add",
  "settings:socialAccounts:delete",
  "settings:socialAccounts:list",
  "settings:socialAccounts:login",
  "settings:socialAccounts:status",
  "settings:socialAccounts:update",
  ...
  "signals:getHandoff",
  "signals:ideas",
  "signals:resolveChannel",
  "signals:resolveIdea",
  "signals:saveConfig",
  "signals:start",
  "skills:changed",
  "skills:delete",
  "skills:deletePersonal",
  "skills:get",
  "skills:getDetail",
  ...
  "views:list",
  "views:save",
  "website:approveBuild",
  "website:approveTarget",
  "website:build",
  "website:captureSync",
  "website:clearApproval",
  "website:clearBrief",
  "website:domainCheck",
  "website:domainSet",
  "website:history",
  ...
  "workflow-runs:resolve-attention",
  ...
  "workspaceTeam:ownerRecovery:approve",
  "workspaceTeam:ownerRecovery:recover",
  "workspaceTeam:ownerRecovery:rotate",
