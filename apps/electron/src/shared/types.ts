...
export interface ElectronAPI {
  ...
  listTradeGodExecutions(): Promise<import('@trade-god/contracts').ExecutionRecord[]>
  ...
  startOptionsCertification(input: import('../main/trading/options-connection-service').StartOptionsCertificationInput): Promise<import('../main/trading/options-connection-service').OptionsConnectionStatus>
