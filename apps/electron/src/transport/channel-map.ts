...
export const CHANNEL_MAP = {
  ...
  testInworldTts: invoke(RPC_CHANNELS.secrets.TEST_INWORLD),
  ...
  // Community records
  getWebsiteStatus: invoke(RPC_CHANNELS.website.STATUS),
  getWebsiteHistory: invoke(RPC_CHANNELS.website.HISTORY),
  approveWebsiteBuild: invoke(RPC_CHANNELS.website.APPROVE_BUILD),
  clearWebsiteApproval: invoke(RPC_CHANNELS.website.CLEAR_APPROVAL),
  approveWebsiteTarget: invoke(RPC_CHANNELS.website.APPROVE_TARGET),
  publishWebsite: invoke(RPC_CHANNELS.website.PUBLISH),
  rollbackWebsite: invoke(RPC_CHANNELS.website.ROLLBACK),
  setWebsiteTrustedMode: invoke(RPC_CHANNELS.website.SET_TRUSTED_MODE),
  buildWebsite: invoke(RPC_CHANNELS.website.BUILD),
  previewWebsite: invoke(RPC_CHANNELS.website.PREVIEW),
  syncWebsiteCapture: invoke(RPC_CHANNELS.website.CAPTURE_SYNC),
  setWebsiteDomain: invoke(RPC_CHANNELS.website.DOMAIN_SET),
  checkWebsiteDomain: invoke(RPC_CHANNELS.website.DOMAIN_CHECK),
  runWebsiteRoutine: invoke(RPC_CHANNELS.website.RUN_ROUTINE),
  ...
  getCommunityRoutine: invoke(RPC_CHANNELS.community.GET_ROUTINE),
  setCommunityRoutine: invoke(RPC_CHANNELS.community.SET_ROUTINE),
  ...
  getSkillIcon: invoke(RPC_CHANNELS.skills.GET_ICON),
  getSkillNotices: invoke(RPC_CHANNELS.skills.GET_NOTICES),
  getSkillDetail: invoke(RPC_CHANNELS.skills.GET_DETAIL),
  importSkillPersonalInstructions: invoke(RPC_CHANNELS.skills.IMPORT_PERSONAL),
  getSkillPersonalInstructions: invoke(RPC_CHANNELS.skills.GET_PERSONAL),
  saveSkillPersonalInstructions: invoke(RPC_CHANNELS.skills.SAVE_PERSONAL),
  deleteSkillPersonalInstructions: invoke(RPC_CHANNELS.skills.DELETE_PERSONAL),
  ...
  getSignalState: invoke(RPC_CHANNELS.signals.GET),
  resolveSignalChannel: invoke(RPC_CHANNELS.signals.RESOLVE_CHANNEL),
  saveSignalConfig: invoke(RPC_CHANNELS.signals.SAVE_CONFIG),
  startSignalResearch: invoke(RPC_CHANNELS.signals.START),
  getSignalIdeas: invoke(RPC_CHANNELS.signals.IDEAS),
  resolveSignalIdea: invoke(RPC_CHANNELS.signals.RESOLVE_IDEA),
  findSignalHandoff: invoke(RPC_CHANNELS.signals.FIND_HANDOFF),
  bindSignalHandoff: invoke(RPC_CHANNELS.signals.BIND_HANDOFF),
