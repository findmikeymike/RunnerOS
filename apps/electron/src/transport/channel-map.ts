...
export const CHANNEL_MAP = {
  ...
  completeTeamRun: invoke(RPC_CHANNELS.teamRuns.COMPLETE),
  tickTeamRun: invoke(RPC_CHANNELS.teamRuns.TICK),
  listTeamRunTicks: invoke(RPC_CHANNELS.teamRuns.LIST_TICKS),
  wakeTeamRunAgent: invoke(RPC_CHANNELS.teamRuns.WAKE_AGENT),
