...
Acceptance: “help me build a capability for this opportunity” reaches the right worker, checks what exists, produces a reviewable result, and explains how to use it. Naming, exact tool authority, and automatic suggestion cadence remain design decisions.
