...
Revision r8. Graph/status authority: [plan.json](plan.json). Technical contract and acceptance IDs: [specification.md](specification.md).
...
- **T-06, runtime owner:** remaining host lifecycle/actor/key wiring, without enabling public admission before the rollout phase. Own escalation integration and relevant SessionManager control paths. Acceptance A-08/11/15/16.
