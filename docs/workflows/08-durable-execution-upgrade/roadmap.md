...
- **T-06E, controls integration owner, accepted:** explicit durable control RPC and Electron transport, immutable retry receipts and prompt cancellation acknowledgement. See [control integration evidence](evidence/T-06E-controls.md).

- **T-06F, host lifecycle owner, accepted internal slice:** protected journal startup and safe shutdown/drain. See [task packet](tasks/T-06F.md). Factory remains unregistered in Electron bootstrap.

- **T-06, runtime owner:** remaining production host/actor/key wiring, without enabling public admission before the rollout phase. Own escalation integration and relevant SessionManager control paths. Acceptance A-08/11/15/16.
