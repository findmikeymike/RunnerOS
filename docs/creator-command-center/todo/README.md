...
| [50 Built-in Skill Protection](./50-built-in-skill-protection-spec.md) | Keeps managed skill internals private in normal app use while preserving discovery, runtime access, and personal instructions | implementation in progress on codex/built-in-skill-protection; acceptance pending |
