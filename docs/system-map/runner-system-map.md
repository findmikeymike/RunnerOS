...
- Permission modes: ask 28, safe 6
...
- Signals: `agent-catalog-aware`, `approval-capable`, `artifact-output-aware`, `context-doc-aware`, `explicit-approval-required`, `external-action-boundary`, `memory-scope-instructions`
