...
export const ORDER_FLOW_MARKET_INPUT_SCHEMA_VERSION = 'order-flow-market-input@1'
export const ORDER_FLOW_MARKET_ARTIFACT_SCHEMA_VERSION = 'order-flow-artifact@2'
...
export const IBKR_GATEWAY_HEALTH_SCHEMA_VERSION = 'ibkr-gateway-health@1'
export const CHART_ANNOTATION_SCHEMA_VERSION = 'chart-annotation@1'
...
export const MARKET_SESSION_WINDOW_SCHEMA_VERSION = 'market-session-window@1'
export const MARKET_FEED_CONTINUITY_SCHEMA_VERSION = 'market-feed-continuity@1'
export const AGENT_MARKET_SNAPSHOT_SCHEMA_VERSION = 'agent-market-snapshot@2'
