...
export const CONFIG_FILE = join(RUNTIME_IDENTITY.dataRoot, 'config.json');
...
export const LOG_DIR = RUNTIME_IDENTITY.logsRoot;
...
function getErrorFilePath(): string {
  ...
  return join(RUNTIME_IDENTITY.dataRoot, 'api-error.json');
}
