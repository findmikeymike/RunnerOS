...
import { DEFAULT_MODEL, isAdaptiveThinkingAlwaysOnModel, isClaudeModel, getDefaultSummarizationModel, getModelContextWindow } from '../config/models.ts';
...
export function resolveClaudeThinkingOptions(args: {
  ...
  // Mythos-class models (Fable / Mythos) have adaptive thinking always on and
  // reject `disabled` outright. The floor is adaptive at 'low' effort.
