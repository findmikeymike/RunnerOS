...
export interface SessionScopedToolCallbacks {
  ...
  websiteInspectExternalFn?: (
    input: import('@craft-agent/session-tools-core').WebsiteInspectExternalInput,
  ) => Promise<import('@craft-agent/session-tools-core').WebsiteToolResult>;
  ...
  getSocialVariantSetFn?: (
    input: import('@craft-agent/session-tools-core').GetSocialVariantSetToolInput,
  ...
  setupSocialAccountFn?: (input: import('@craft-agent/session-tools-core').SetupSocialAccountInput) => Promise<unknown>;
  saveSecretFn?: (
