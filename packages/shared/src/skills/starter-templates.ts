...
Do not immediately render a batch. Begin in this vein:
...
3. Present 2-5 concise variant plans. For each, state the hook, selected structure, destination account, and why it is meaningfully different.
4. Wait for strategic approval. Fill \`variant-brief.template.json\` with the approved source hash, rights basis, destinations, and time ranges.
