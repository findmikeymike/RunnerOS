  ...
  return {
    ...
    guide: {
      raw: [
        ...
        '2. `node bin/genesis-lyric.mjs storyboard --brief-file <brief.json> --json` for no-spend Genesis Creative Director / Motion Director shot planning.',
        ...
        '',
        '`storyboard` can run before a visual exists. Rendering must provide `lyrics` or timed `lyric_lines`, plus one visual source as `video_file` or `image_file`. The visual can be user footage, user artwork, or an asset generated by another tool from the storyboard prompts. Supported aspect ratios: `9:16`, `1:1`, `16:9`.',
        '',
