  ...
  return {
    ...
    guide: {
      raw: [
        ...
        '',
        'Workflow:',
        '1. Use the connected native YouTube route first. If unavailable, use the pinned Monid metadata/transcript routes in the monid skill; guarded Zero transcription is the final fallback. A Data API key does not grant third-party transcript access.',
