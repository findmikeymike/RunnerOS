  ...
  return {
    ...
    guide: {
      raw: [
        ...
        '6. Default engine is `runner-cdp`: save dry-run JSON as the action contract, then run `node src/social.mjs execute --action-file <dry-run-result.json> --expected-action-id <act_...> --confirm yes --json` after explicit approval.',
        ...
        '8. Dry-run posts, comments, and DMs with the selected `--profile`, `--asset-root`, `--content-root`, relative filenames, and `--dry-run --json` before live execution.',
