  ...
  return {
    ...
    guide: {
      raw: [
        ...
        '7. Review `edit/render-report.json` or the master-sync report before claiming the edit is done.',
        '',
  ...
  return {
    ...
    guide: {
      raw: [
        ...
        '10. For Meta or Google dashboard work, run `browser_tool accounts` and attach the exact saved profile from Settings > Ad Accounts with `browser_tool account <meta-ads|google-ads> <profile>` before navigation.',
      ].join('\n'),
    },
    isBuiltin: true,
  };
