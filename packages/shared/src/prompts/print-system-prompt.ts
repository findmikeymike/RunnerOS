...
const systemPrompt = getSystemPrompt(
  ...
  '/Users/example/.trade-god/workspaces/abc123' // Example workspace path
);
...
const systemPromptWithDebug = getSystemPrompt(
  ...
  '/Users/example/.trade-god/workspaces/abc123'
);
...
const sessionState = formatSessionState('260121-example-session', {
  plansFolderPath:
    '/Users/example/.trade-god/workspaces/abc123/sessions/260121-example-session/plans',
});
