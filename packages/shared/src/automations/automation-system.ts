...
import { PromptHandler, EventLogHandler, WebhookHandler, ShellHookHandler, AcpSpawnHandler, type AutomationsConfigProvider, type ShellHookOutcome } from './handlers/index.ts';
