...
export const BUILTIN_AGENT_REGISTRATIONS: readonly BuiltinAgentRegistration[] = [
  ...
  { slug: 'social-publisher', required: true, workerGroup: 'campaign', workerOrder: 16, activationGroup: 'campaign', activationOrder: 4 },
  ...
  { slug: 'video-director', required: true, workerGroup: 'campaign', workerOrder: 14, activationGroup: 'campaign', activationOrder: 2 },
  { slug: 'lottie-animation-agent', required: true },
  { slug: 'video-editor-agent', required: true, workerGroup: 'campaign', workerOrder: 15, activationGroup: 'campaign', activationOrder: 3 },
  ...
  { slug: 'art-director', required: true, workerGroup: 'campaign', workerOrder: 5, activationGroup: 'campaign', activationOrder: 1 },
