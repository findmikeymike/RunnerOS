...
2. Use the bundled \`google-ads\` source and skill for Google Ads API v24 account discovery, GAQL reporting, field lookup, campaign/ad group/keyword inspection, budget review, asset/conversion checks, recommendations, and planning.
