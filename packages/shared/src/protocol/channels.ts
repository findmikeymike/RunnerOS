...
export const RPC_CHANNELS = {
  ...
  llmConnections: {
    ...
    GET_FALLBACK_CHAIN: 'LLM_Connection:getFallbackChain',
    SET_FALLBACK_CHAIN: 'LLM_Connection:setFallbackChain',
    SET_CONNECTION_FALLBACK_CHAIN: 'LLM_Connection:setConnectionFallbackChain',
    REFRESH_MODELS: 'LLM_Connection:refreshModels',
    DISCOVER_OMNIROUTE_MODELS: 'LLM_Connection:discoverOmniRouteModels',
  ...
  settings: {
    ...
    AD_BROWSER_ACCOUNTS_LIST: 'settings:adBrowserAccounts:list',
    AD_BROWSER_ACCOUNTS_SAVE: 'settings:adBrowserAccounts:save',
    AD_BROWSER_ACCOUNTS_DELETE: 'settings:adBrowserAccounts:delete',
    AD_BROWSER_ACCOUNTS_LOGIN: 'settings:adBrowserAccounts:login',
    AD_BROWSER_ACCOUNTS_STATUS: 'settings:adBrowserAccounts:status',
  },
  pi: {
  ...
  skills: {
    ...
    GET_DETAIL: 'skills:getDetail',
    GET_NOTICES: 'skills:getNotices',
    GET_ICON: 'skills:getIcon',
    GET_PERSONAL: 'skills:getPersonal',
    IMPORT_PERSONAL: 'skills:importPersonal',
    SAVE_PERSONAL: 'skills:savePersonal',
    DELETE_PERSONAL: 'skills:deletePersonal',
  ...
  browserPane: {
    ...
    UPDATE_DOCK_BOUNDS: 'browser-pane:update-dock-bounds',
    HIDE_SIDECAR: 'browser-pane:hide-sidecar',
    POP_OUT: 'browser-pane:pop-out',
  ...
  workflowRuns: {
    ...
    DURABLE_CONTROL: 'workflow-runs:durable-control',
  ...
  outputs: {
    ...
    ARCHIVE_SOCIAL_VARIANT: 'outputs:archiveSocialVariant',
    REBIND_SOCIAL_VARIANT_SET: 'outputs:rebindSocialVariantSet',
