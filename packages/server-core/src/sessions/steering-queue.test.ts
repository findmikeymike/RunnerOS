...
describe('steering queue recovery', () => {
  ...
  test('preserves durable attachment and replay options after JSON persistence', () => {
    ...
    const accepted: Message = {
      ...
      backgroundFence: 'owner-fence', hidden: true, displayIntent: 'agent-delegation-task', inputOrigin: 'agent', attachments: [stored],
    ...
    expect(recovered).toEqual({
      ...
      options: { ...accepted.queuedOptions, backgroundFence: 'owner-fence', hidden: true, displayIntent: 'agent-delegation-task', inputOrigin: 'agent', badges: accepted.badges },
    })
