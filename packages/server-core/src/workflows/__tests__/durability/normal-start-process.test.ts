...
test.each(['start', 'multi', 'sources', 'inputs', 'structured'])('normal runner %s reaches default Pi backend and performs native reads in isolated configuration', async (mode) => {
